...
const ClassicFavoritesSection = () => {
    return (
        <section
            className={`classic-favorites-section w-full h-full bg-white relative pb-10 md:pb-0 bg-bg-linear-pink-2`}>
            <div className={`container mx-auto py-32`}>
                ...
                <div className={`text-center relative`}>
                    ...
                    <p className={`text-lg text-clr-grey mt-4`}>Check out our top products that our customers love.</p>
                </div>
                <div className={`mt-10`}>
